<template>
    <nav class="flex items-center justify-between flex-wrap bg-red p-4 sticky pin-t z-10">
        <nuxt-link to="/" class="flex items-center flex-no-shrink text-white mr-6 no-underline"
                   v-show="!showNavLinks">
            <svg class="inline-block w-8 h-8 fill-current" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
