<template>
  <form id="donationform" class="flex flex-col" @submit.prevent="handleCreditCardPayment">
    ...
    <button
      ...
      class="bg-green-500 hover:bg-green-400 px-16 py-2 text-white text-base leading-6 font-medium transition ease-in-out duration-150 mx-auto shadow-lg border border-green-400 mt-8"
    >
      <span v-if="!loading">
