            ...
            <div class="flex">
                <a href="https://github.com/manniL" target="blank" rel="noreferrer noopener nofollow"
                   class="text-center text-grey-dark no-underline bg-grey-light px-3 py-2 m-2 rounded hover:text-black">
                    <svg class="inline-block w-8 h-8" viewBox="0 -100 1792 1792" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="mailto:hello@lichter.io" target="blank" rel="noreferrer noopener nofollow"
                   class="text-center text-grey-dark no-underline bg-grey-light px-3 py-2 m-2 rounded hover:text-teal-darker">
                    <svg class="inline-block w-8 h-8" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="tel:+4917670625208" target="blank" rel="noreferrer noopener nofollow"
                   class="text-center text-grey-dark no-underline bg-grey-light px-3 py-2 m-2 rounded hover:text-green-dark">
                    <svg class="w-8 h-8" viewBox="0 -100 1792 1792" xmlns="http://www.w3.org/2000/svg">
